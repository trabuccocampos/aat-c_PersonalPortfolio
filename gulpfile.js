...
gulp.task('scripts', function(){
    return gulp.src(['./app/assets/scripts/vendor/*.js','./app/assets/scripts/*.js'])
    .pipe($.jshint())
...
// Main Build sequence
gulp.task('build', ['styles-build', 'scripts', 'images']);
...
gulp.task('serve', ['php', 'styles-build', 'scripts'], function () {
    browserSync({
